...
function _startHandler() {
  _startHandler = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(msg) {
    var chatId, username, userRepo, create, job, jobDesc;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            if (currentJobs.some(function (e) {
              return Number(e.chatId) === Number(chatId);
            })) {
              _context2.next = 16;
              break;
            }
          ...
          case 16:
            console.log({
              'currentJobs on /start': currentJobs
            });
...
function _changeFrequency() {
  _changeFrequency = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(msg, match) {
    var chatId, userRepo, changed, job, jobDesc, newJob;
...
function _enableNotifications() {
  _enableNotifications = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(msg) {
    var chatId, userRepo, enabled, _userRepo$read, _userRepo$read2, user, job, jobDesc;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 4:
            ...
            _userRepo$read = userRepo.read({
              row: 'chatId',
              value: chatId
            }), _userRepo$read2 = _slicedToArray(_userRepo$read, 1), user = _userRepo$read2[0];
            _context5.next = 9;
            return createJob({
    ...
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            chatId = msg.chat.id;
            message = ['/off - disables auto-notifications', '/on - enables auto-notifications', '/send_every [minutes] - set notification frequency', '/info'];
...
function _createJobs() {
  _createJobs = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
    ...
    }, _callee9, null, [[10, 25, 29, 37], [30,, 32, 36]]);
  }));
  return _createJobs.apply(this, arguments);
}
