...
function _getName() {
  _getName = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(_ref2) {
    var origin, username;
...
function changeFrequency(_x3, _x4) {
  return _changeFrequency.apply(this, arguments);
}

function _changeFrequency() {
  _changeFrequency = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(msg, match) {
...
function disableNotifications(_x5) {
  return _disableNotifications.apply(this, arguments);
}

function _disableNotifications() {
  _disableNotifications = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(msg) {
...
function enableNotifications(_x6) {
  return _enableNotifications.apply(this, arguments);
}

function _enableNotifications() {
  _enableNotifications = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(msg) {
...
function jobIsActive(chatId) {
  return currentJobs.some(function (e) {
    return e.chatId === chatId && e.activate === true;
  });
}
...
function _createJobs() {
  _createJobs = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
    ...
    }, _callee7, null, [[9, 24, 28, 36], [29,, 31, 35]]);
  }));
  return _createJobs.apply(this, arguments);
}

function createJob(_x7) {
  return _createJob.apply(this, arguments);
}

function _createJob() {
  _createJob = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(_ref5) {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            cronTimer = "*/".concat(frequency, " 0-21 * * *");
            _context8.next = 4;
          ...
          case 4:
            cb = _context8.sent;
            _context8.prev = 5;
            return _context8.abrupt("return", new CronJob(cronTimer, cb));
